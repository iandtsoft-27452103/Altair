...
Module Analyze
    ...
    Public Sub AnalyzeRecord(ByVal num_tasks As Integer, ByVal num_mate_tasks As Integer, ByVal thinking_time As Integer, ByVal mate_search_depth As Integer, ByVal analyze_file_name As String, ByVal record_file_name As String,
    ...
    Private Sub SetRootOutput(ByRef m As MCTSTree)
        Dim inputData(1 * 105 * 9 * 9 - 1) As Single
    ...
    Public Function ExecValue(ByVal str_sfen As String()) As String()
        ...
        batch_size = str_sfen.Length
        Dim newShape As Integer() = {batch_size + 1, 32, 81}
        str_out = New String(batch_size - 1) {}
    ...
    Private Sub SearchWrapper(ByRef bt As BoardTree, ByVal num_tasks As Integer, ByVal num_mate_tasks As Integer, ByVal thinking_time As Integer, ByVal mate_search_depth As Integer, ByRef str_result As String, ByRef param_str_mate_pv As String, ByVal str_record_move As String,
                ...
                While True
                    ...
                    If p > 0 Then
                        ...
                        For i = 0 To num_tasks - 1
                            ...
                            End If
                        Next i
                        Dim str_ret As String() = ExecPolicy(str_sfen)
                        idx = 0
                        For i = 0 To num_tasks - 1
                            If str_policy_requests(i) <> "" Then
                                Select Case i
