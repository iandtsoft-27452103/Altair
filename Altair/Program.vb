...
Module Program
    Sub Main(args As String())
        ...
        'AnalyzeRecord2(1, 2, 5, 9, 4, 0.5, "analyze_result.txt", "20220403_nhk_hai.txt", "2022/04/03", "第72回NHK杯1回戦", "木村一基九段", "黒田尭之五段")
        ...
        Select Case mode
            ...
            Case 1
                'LSTMを使用して棋譜を解析する。
                AnalyzeRecord2(num_tasks, num_mate_tasks, thinking_time, mate_search_depth, policy_network_threshold, value_lambda, analyze_file_name, record_file_name, str_game_date, str_match_name, str_black_player, str_white_player)
        End Select
